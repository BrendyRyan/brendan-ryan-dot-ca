...
<div class="max-w-prose mx-auto">
  ...
  <p class="mt-8">My name is Brendan Ryan, a CPA from London, Canada.</p>
  <p>I am an accountant and enjoy learning about web development.</p>
  ...
  <p>
    ...
    will tickle my accounting bone.
  </p>
  ...
  <p>
    I'm not overly active on social media, but feel free to check out my Github and LinkedIn profiles, or message me on
    <a href="https://twitter.com/Brendy_Ryan" target="_blank" rel="noopener noreferrer" class="font-bold">Twitter</a>,
    <a
    ...
    <a href="mailto:brendan.james.ryan@gmail.com" class="font-bold">Email</a>
  </p>
</div>
